...
/**
 * @title 来自于EIP3664 https://github.com/DRepublic-io/EIPs/blob/master/EIPS/eip-3664.md
 */
contract ERC3664 is Context, ERC165, IERC3664, IERC3664Metadata {
    ...
    /// @dev attrId => tokenId => amount
    mapping(uint256 => mapping(uint256 => uint256)) internal _balances;
    /// @dev attrId => tokenId => text
    mapping(uint256 => mapping(uint256 => bytes)) internal _texts;
    /// @dev tokenId => primaryId
    mapping(uint256 => uint256) public primaryAttrs;
    /// @dev tokenId => secondaryIds
